...
title Kristal Streams Program Details Panel

set "SOURCE=C:\KristalStreams168RC1R2\KristalStreams-1.6.8-RC1-R2-LEGACY-DEMO-FIX"
for /f %%T in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set "STAMP=%%T"
set "WORK=C:\ksepgdetails-!STAMP!"
set "FINAL=%USERPROFILE%\Downloads\KS-EPG-DETAILS-1682006.apk"
set "LOG=%TEMP%\kristalstreams-epg-details-build.txt"
set "JAVASAVE=%USERPROFILE%\.kristalstreams-java-home.txt"

echo.
echo ==========================================================
echo   KRISTAL STREAMS 1.6.8 RC1 R2 - PROGRAM DETAILS PANEL
echo   FRESH APK: KS-EPG-DETAILS-1682006.apk
echo ==========================================================
echo.
echo Baseline: known-good R2
echo Improves only the panel above the approved working guide.
echo The EPG grid, duration widths, alignment, and title fit are unchanged.
...
echo [2/6] Installing program details panel...
...
if errorlevel 1 (
    echo ERROR: Could not install program details panel.
    pause
    exit /b 1
)

echo [3/6] Verifying program details panel...
...
findstr /c:"1.6.8-epg-details" "%WORK%\app\build.gradle.kts" >nul
if errorlevel 1 (
    echo ERROR: EPG details version verification failed.
    pause
    exit /b 1
)
...
echo.
echo [5/6] Building program details panel...
echo Gradle progress will appear below.
echo.

cd /d "%WORK%"
set "BUILDPS=%TEMP%\ks_epg_details_gradle_build.ps1"
...
if defined USBDRIVE (
    set "USBCOPY=!USBDRIVE!\KS-EPG-DETAILS-1682006.apk"
...
echo ==========================================================
echo.
echo       KRISTAL STREAMS PROGRAM DETAILS BUILD SUCCESSFUL
echo.
echo ==========================================================
echo.
echo APK:
...
echo.
echo Install only KS-EPG-DETAILS-1682006.apk shown above.
echo The details panel now opens with the current program and updates live.
echo The approved EPG grid, card widths, alignment, and title fit are unchanged.
echo.
...

:::END GRADLE
:::BEGIN AUDIT
S1JJU1RBTCBTVFJFQU1TIDEuNi44IFJDMSBSMiDigJQgUFJPR1JBTSBERVRBSUxTIFBBTkVMCgpC
...

:::END AUDIT
