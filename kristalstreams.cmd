...
title Kristal Streams Compact Title Fit

set "SOURCE=C:\KristalStreams168RC1R2\KristalStreams-1.6.8-RC1-R2-LEGACY-DEMO-FIX"
for /f %%T in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set "STAMP=%%T"
set "WORK=C:\ksepgtitles-!STAMP!"
set "FINAL=%USERPROFILE%\Downloads\KS-EPG-TITLE-FIT-1682005.apk"
set "LOG=%TEMP%\kristalstreams-epg-title-fit-build.txt"
set "JAVASAVE=%USERPROFILE%\.kristalstreams-java-home.txt"

echo.
echo ==========================================================
echo   KRISTAL STREAMS 1.6.8 RC1 R2 - COMPACT TITLE FIT
echo   FRESH APK: KS-EPG-TITLE-FIT-1682005.apk
echo ==========================================================
echo.
echo Baseline: known-good R2
echo Fits more title text inside centered half-hour cards.
echo Longer left-aligned cards remain unchanged.
...
echo [2/6] Installing compact title fit...
...
if errorlevel 1 (
    echo ERROR: Could not install compact title fit.
    pause
    exit /b 1
)

echo [3/6] Verifying compact title fit...
...
findstr /c:"1.6.8-epg-title-fit" "%WORK%\app\build.gradle.kts" >nul
if errorlevel 1 (
    echo ERROR: EPG title-fit version verification failed.
    pause
    exit /b 1
)
...
echo.
echo [5/6] Building compact title fit...
echo Gradle progress will appear below.
echo.

cd /d "%WORK%"
set "BUILDPS=%TEMP%\ks_epg_title_fit_gradle_build.ps1"
...
if defined USBDRIVE (
    set "USBCOPY=!USBDRIVE!\KS-EPG-TITLE-FIT-1682005.apk"
...
echo ==========================================================
echo.
echo       KRISTAL STREAMS COMPACT TITLE FIT BUILD SUCCESSFUL
echo.
echo ==========================================================
echo.
echo APK:
...
echo.
echo Install only KS-EPG-TITLE-FIT-1682005.apk shown above.
echo Half-hour titles now have six lines, tighter padding, and wider auto-sizing.
echo Longer left-aligned cards and all duration widths remain unchanged.
echo.
...
ZXJzaW9uQ29kZSA9IDE2ODIwMDUKICAgICAgICB2ZXJzaW9uTmFtZSA9ICIxLjYuOC1lcGctdGl0
bGUtZml0IgogICAgfQoKICAgIGJ1aWxkRmVhdHVyZXMgewogICAgICAgIHZpZXdCaW5kaW5nID0g
...
:::END GRADLE
:::BEGIN AUDIT

:::END AUDIT
