...
title KS Clean Screen 1682013

set "SOURCE=C:\KristalStreams168RC1R2\KristalStreams-1.6.8-RC1-R2-LEGACY-DEMO-FIX"
for /f %%T in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set "STAMP=%%T"
set "WORK=C:\kscleanscreen-!STAMP!"
set "FINAL=%USERPROFILE%\Downloads\KS-CLEAN-SCREEN-1682013.apk"
set "LOG=%TEMP%\ks-clean-screen-1682013-build.txt"
set "JAVASAVE=%USERPROFILE%\.kristalstreams-java-home.txt"

echo.
echo ==========================================================
echo   KRISTAL STREAMS 1.6.8 RC1 R2 - CLEAN FULLSCREEN
echo   FRESH APK: KS-CLEAN-SCREEN-1682013.apk
echo ==========================================================
echo.
...
findstr /c:"AspectRatioFrameLayout.RESIZE_MODE_ZOOM" "%WORK%\app\src\main\java\com\kristalstreams\player\PlaybackImmersiveProvider.kt" >nul
if errorlevel 1 (
    echo ERROR: Full-display video zoom verification failed.
    pause
    exit /b 1
)
...
findstr /c:"1.6.8-clean-playback" "%WORK%\app\build.gradle.kts" >nul
if errorlevel 1 (
...
cd /d "%WORK%"
set "BUILDPS=%TEMP%\ks_clean_screen_1682013_gradle_build.ps1"
...
if defined USBDRIVE (
    set "USBCOPY=!USBDRIVE!\KS-CLEAN-SCREEN-1682013.apk"
...
echo ==========================================================
echo.
echo       KS CLEAN SCREEN BUILD SUCCESSFUL
echo.
echo ==========================================================
echo.
echo APK:
...
echo.
echo Install only KS-CLEAN-SCREEN-1682013.apk shown above.
...
echo Video uses aspect-safe zoom to fill extra-wide displays without stretching.
...
ZXJzaW9uQ29kZSA9IDE2ODIwMTMKICAgICAgICB2ZXJzaW9uTmFtZSA9ICIxLjYuOC1jbGVhbi1w
bGF5YmFjayIKICAgIH0KCiAgICBidWlsZEZlYXR1cmVzIHsKICAgICAgICB2aWV3QmluZGluZyA9
...
ICB9CgogICAgICAgIGhpZGVTeXN0ZW1CYXJzKGFjdGl2aXR5KQogICAgICAgIGV4cGFuZFZpZGVv
VG9GaWxsKGFjdGl2aXR5KQogICAgICAgIHJlbW92ZUNoYW5uZWxCYW5uZXIoYWN0aXZpdHkpCgog
...

:::END IMMERSIVE
