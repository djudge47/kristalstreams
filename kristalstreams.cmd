...
title Kristal Streams Complete EPG Rebuild

set "SOURCE=C:\KristalStreams168RC1R2\KristalStreams-1.6.8-RC1-R2-LEGACY-DEMO-FIX"
for /f %%T in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set "STAMP=%%T"
set "WORK=C:\ksepgrebuild-!STAMP!"
set "FINAL=%USERPROFILE%\Downloads\KS-EPG-REBUILD-1682000.apk"
set "LOG=%TEMP%\kristalstreams-epg-rebuild-build.txt"
set "JAVASAVE=%USERPROFILE%\.kristalstreams-java-home.txt"

echo.
echo ==========================================================
echo   KRISTAL STREAMS 1.6.8 RC1 R2 - COMPLETE EPG REBUILD
echo   FRESH APK: KS-EPG-REBUILD-1682000.apk
echo ==========================================================
echo.
echo Baseline: known-good R2
echo The previous variable-width EPG renderer has been removed.
echo This installs a fixed half-hour grid based on the working APK.
...
echo [2/6] Installing the rebuilt EPG component...
...
if errorlevel 1 (
    echo ERROR: Could not install the rebuilt EPG component.
    pause
    exit /b 1
)

echo [3/6] Verifying the complete EPG replacement...
...
if errorlevel 1 (
    echo ERROR: Centered program-label verification failed.
    pause
    exit /b 1
)
...
findstr /c:"1.6.8-epg-rebuild" "%WORK%\app\build.gradle.kts" >nul
if errorlevel 1 (
    echo ERROR: EPG rebuild version verification failed.
    pause
    exit /b 1
)
...
echo.
echo [5/6] Building the complete EPG replacement...
echo Gradle progress will appear below.
echo.

cd /d "%WORK%"
set "BUILDPS=%TEMP%\ks_epg_rebuild_gradle_build.ps1"
...
if defined USBDRIVE (
    set "USBCOPY=!USBDRIVE!\KS-EPG-REBUILD-1682000.apk"
...
echo ==========================================================
echo.
echo       KRISTAL STREAMS COMPLETE EPG REBUILD SUCCESSFUL
echo.
echo ==========================================================
echo.
echo APK:
...
echo.
echo Install only KS-EPG-REBUILD-1682000.apk shown above.
echo The old variable-width EPG renderer is no longer used.
echo Every channel now uses identical aligned half-hour guide cells.
echo.
...

...

:::END ADAPTER
:::BEGIN GRADLE
...
ZXJzaW9uQ29kZSA9IDE2ODIwMDAKICAgICAgICB2ZXJzaW9uTmFtZSA9ICIxLjYuOC1lcGctcmVi
dWlsZCIKICAgIH0KCiAgICBidWlsZEZlYXR1cmVzIHsKICAgICAgICB2aWV3QmluZGluZyA9IGZh
...
:::END GRADLE
:::BEGIN AUDIT

:::END AUDIT
