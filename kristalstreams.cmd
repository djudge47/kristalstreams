...
title KS Movies Complete 1682020

set "SOURCE=C:\KristalStreams168RC1R2\KristalStreams-1.6.8-RC1-R2-LEGACY-DEMO-FIX"
for /f %%T in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set "STAMP=%%T"
set "WORK=C:\ksmoviescomplete-!STAMP!"
set "FINAL=%USERPROFILE%\Downloads\KS-MOVIES-COMPLETE-1682020.apk"
set "LOG=%TEMP%\ks-movies-complete-1682020-build.txt"
set "JAVASAVE=%USERPROFILE%\.kristalstreams-java-home.txt"

echo.
echo ==========================================================
echo   KRISTAL STREAMS 1.6.8 RC1 R2 - COMPLETE MOVIES
echo   FRESH APK: KS-MOVIES-COMPLETE-1682020.apk
echo ==========================================================
echo.
...
echo [2/6] Installing verified 1682019 baseline and complete Movies upgrade...
...
echo [3/6] Verifying complete Movies upgrade and stable playback...
...
findstr /c:"1.6.8-movies-complete" "%WORK%\app\build.gradle.kts" >nul
if errorlevel 1 (
...
echo.
echo [5/6] Building complete Movies APK...
echo Gradle progress will appear below.
echo.

cd /d "%WORK%"
set "BUILDPS=%TEMP%\ks_movies_complete_1682020_gradle_build.ps1"
...
if defined USBDRIVE (
    set "USBCOPY=!USBDRIVE!\KS-MOVIES-COMPLETE-1682020.apk"
...
echo ==========================================================
echo.
echo       KS COMPLETE MOVIES BUILD SUCCESSFUL
echo.
echo ==========================================================
echo.
echo APK:
...
echo.
echo Install only KS-MOVIES-COMPLETE-1682020.apk shown above.
...

TG9uZykK
:::END MODELS
:::BEGIN XTREAM
...

...

:::END XTREAM
:::BEGIN GUIDE
...
ZXJzaW9uQ29kZSA9IDE2ODIwMjAKICAgICAgICB2ZXJzaW9uTmFtZSA9ICIxLjYuOC1tb3ZpZXMt
...

Y3Rpdml0eS4nCn0K
:::END UIPATCH
...

...

:::END LIBRARY
