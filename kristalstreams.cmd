...
title KS Series Complete 1682021

set "SOURCE=C:\KristalStreams168RC1R2\KristalStreams-1.6.8-RC1-R2-LEGACY-DEMO-FIX"
for /f %%T in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set "STAMP=%%T"
set "WORK=C:\ksseriescomplete-!STAMP!"
set "FINAL=%USERPROFILE%\Downloads\KS-SERIES-COMPLETE-1682021.apk"
set "LOG=%TEMP%\ks-series-complete-1682021-build.txt"
set "JAVASAVE=%USERPROFILE%\.kristalstreams-java-home.txt"

echo.
echo ==========================================================
echo   KRISTAL STREAMS 1.6.8 RC1 R2 - COMPLETE SERIES
echo   FRESH APK: KS-SERIES-COMPLETE-1682021.apk
echo ==========================================================
echo.
...
echo [2/6] Installing verified 1682020 baseline and complete Series upgrade...
...
echo [3/6] Verifying complete Series upgrade and stable playback...
...
findstr /c:"1.6.8-series-complete" "%WORK%\app\build.gradle.kts" >nul
if errorlevel 1 (
...
echo.
echo [5/6] Building complete Series APK...
