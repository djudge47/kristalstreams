...
title KS True 16x9 1682014

set "SOURCE=C:\KristalStreams168RC1R2\KristalStreams-1.6.8-RC1-R2-LEGACY-DEMO-FIX"
for /f %%T in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set "STAMP=%%T"
set "WORK=C:\kstrue16x9-!STAMP!"
set "FINAL=%USERPROFILE%\Downloads\KS-TRUE-16X9-1682014.apk"
set "LOG=%TEMP%\ks-true-16x9-1682014-build.txt"
set "JAVASAVE=%USERPROFILE%\.kristalstreams-java-home.txt"

echo.
echo ==========================================================
echo   KRISTAL STREAMS 1.6.8 RC1 R2 - TRUE 16:9 PLAYBACK
echo   FRESH APK: KS-TRUE-16X9-1682014.apk
echo ==========================================================
echo.
...
echo Preserves the original 16:9 picture without cropping or stretching.
...
findstr /c:"AspectRatioFrameLayout.RESIZE_MODE_FIT" "%WORK%\app\src\main\java\com\kristalstreams\player\PlaybackImmersiveProvider.kt" >nul
if errorlevel 1 (
    echo ERROR: True 16:9 video fit verification failed.
    pause
    exit /b 1
)
...
findstr /c:"1.6.8-16x9-playback" "%WORK%\app\build.gradle.kts" >nul
if errorlevel 1 (
...
cd /d "%WORK%"
set "BUILDPS=%TEMP%\ks_true_16x9_1682014_gradle_build.ps1"
...
if defined USBDRIVE (
    set "USBCOPY=!USBDRIVE!\KS-TRUE-16X9-1682014.apk"
...
echo ==========================================================
echo.
echo       KS TRUE 16:9 BUILD SUCCESSFUL
echo.
echo ==========================================================
echo.
echo APK:
...
echo.
echo Install only KS-TRUE-16X9-1682014.apk shown above.
...
echo Video preserves its 16:9 aspect ratio without cropping or stretching.
...
ZXJzaW9uQ29kZSA9IDE2ODIwMTQKICAgICAgICB2ZXJzaW9uTmFtZSA9ICIxLjYuOC0xNng5LXBs
YXliYWNrIgogICAgfQoKICAgIGJ1aWxkRmVhdHVyZXMgewogICAgICAgIHZpZXdCaW5kaW5nID0g
...

b25BcmdzOiBBcnJheTxvdXQgU3RyaW5nPj8pOiBJbnQgPSAwCn0K
:::END IMMERSIVE
