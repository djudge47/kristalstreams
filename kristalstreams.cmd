...
title Kristal Streams Centered Duration EPG

set "SOURCE=C:\KristalStreams168RC1R2\KristalStreams-1.6.8-RC1-R2-LEGACY-DEMO-FIX"
for /f %%T in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set "STAMP=%%T"
set "WORK=C:\ksepgcentered-!STAMP!"
set "FINAL=%USERPROFILE%\Downloads\KS-EPG-CENTERED-1682003.apk"
set "LOG=%TEMP%\kristalstreams-epg-centered-build.txt"
set "JAVASAVE=%USERPROFILE%\.kristalstreams-java-home.txt"

echo.
echo ==========================================================
echo   KRISTAL STREAMS 1.6.8 RC1 R2 - CENTERED DURATION EPG
echo   FRESH APK: KS-EPG-CENTERED-1682003.apk
echo ==========================================================
echo.
echo Baseline: known-good R2
echo Centers all program text and automatically sizes long titles.
echo Duration-width cards and the non-stacking grid are retained.
...
echo [2/6] Installing the centered duration EPG component...
...
if errorlevel 1 (
    echo ERROR: Could not install the centered duration EPG component.
    pause
    exit /b 1
)

echo [3/6] Verifying the centered duration EPG...
...
findstr /c:"1.6.8-epg-centered" "%WORK%\app\build.gradle.kts" >nul
if errorlevel 1 (
    echo ERROR: Centered EPG version verification failed.
    pause
    exit /b 1
)
...
echo.
echo [5/6] Building the centered duration EPG...
echo Gradle progress will appear below.
echo.

cd /d "%WORK%"
set "BUILDPS=%TEMP%\ks_epg_centered_gradle_build.ps1"
...
if defined USBDRIVE (
    set "USBCOPY=!USBDRIVE!\KS-EPG-CENTERED-1682003.apk"
...
echo ==========================================================
echo.
echo       KRISTAL STREAMS CENTERED DURATION EPG BUILD SUCCESSFUL
echo.
echo ==========================================================
echo.
echo APK:
...
echo.
echo Install only KS-EPG-CENTERED-1682003.apk shown above.
echo Program titles are centered and automatically resized to fit.
...

cy5kaXNwbGF5TWV0cmljcy5kZW5zaXR5KS50b0ludCgpCn0K
:::END ADAPTER
:::BEGIN GRADLE
...
ZXJzaW9uQ29kZSA9IDE2ODIwMDMKICAgICAgICB2ZXJzaW9uTmFtZSA9ICIxLjYuOC1lcGctY2Vu
dGVyZWQiCiAgICB9CgogICAgYnVpbGRGZWF0dXJlcyB7CiAgICAgICAgdmlld0JpbmRpbmcgPSBm
...
:::END GRADLE
:::BEGIN AUDIT
S1JJU1RBTCBTVFJFQU1TIDEuNi44IFJDMSBSMiDigJQgQ0VOVEVSRUQgRFVSQVRJT04gRVBHCgpC
...

:::END AUDIT
