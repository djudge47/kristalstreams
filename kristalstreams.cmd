...
title Kristal Streams Visible Channel Logos

set "SOURCE=C:\KristalStreams168RC1R2\KristalStreams-1.6.8-RC1-R2-LEGACY-DEMO-FIX"
for /f %%T in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set "STAMP=%%T"
set "WORK=C:\ksepglogos-!STAMP!"
set "FINAL=%USERPROFILE%\Downloads\KS-EPG-CHANNEL-LOGOS-1682007.apk"
set "LOG=%TEMP%\kristalstreams-epg-channel-logos-build.txt"
set "JAVASAVE=%USERPROFILE%\.kristalstreams-java-home.txt"

echo.
echo ==========================================================
echo   KRISTAL STREAMS 1.6.8 RC1 R2 - VISIBLE CHANNEL LOGOS
echo   FRESH APK: KS-EPG-CHANNEL-LOGOS-1682007.apk
echo ==========================================================
echo.
echo Baseline: known-good R2
echo Displays provider logos inside the left-side channel boxes.
...
echo [2/6] Installing visible channel logos...
...
if errorlevel 1 (
    echo ERROR: Could not install visible channel logos.
    pause
    exit /b 1
)

echo [3/6] Verifying visible channel logos...
...
findstr /c:"1.6.8-epg-channel-logos" "%WORK%\app\build.gradle.kts" >nul
if errorlevel 1 (
    echo ERROR: EPG channel-logo version verification failed.
    pause
    exit /b 1
)
...
echo.
echo [5/6] Building visible channel logos...
echo Gradle progress will appear below.
echo.

cd /d "%WORK%"
set "BUILDPS=%TEMP%\ks_epg_channel_logos_gradle_build.ps1"
...
if defined USBDRIVE (
    set "USBCOPY=!USBDRIVE!\KS-EPG-CHANNEL-LOGOS-1682007.apk"
...
echo ==========================================================
echo.
echo       KRISTAL STREAMS VISIBLE CHANNEL LOGOS BUILD SUCCESSFUL
echo.
echo ==========================================================
echo.
echo APK:
...
echo.
echo Install only KS-EPG-CHANNEL-LOGOS-1682007.apk shown above.
echo Provider logos now appear on a visible light tile in each channel box.
...

:::END ADAPTER
:::BEGIN GRADLE
...
ZXJzaW9uQ29kZSA9IDE2ODIwMDcKICAgICAgICB2ZXJzaW9uTmFtZSA9ICIxLjYuOC1lcGctY2hh
bm5lbC1sb2dvcyIKICAgIH0KCiAgICBidWlsZEZlYXR1cmVzIHsKICAgICAgICB2aWV3QmluZGlu
...
:::END GRADLE
:::BEGIN AUDIT
S1JJU1RBTCBTVFJFQU1TIDEuNi44IFJDMSBSMiDigJQgVklTSUJMRSBDSEFOTkVMIExPR09TCgpC
...

:::END AUDIT
