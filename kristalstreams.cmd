...
title KS Stretch Fullscreen 1682015

set "SOURCE=C:\KristalStreams168RC1R2\KristalStreams-1.6.8-RC1-R2-LEGACY-DEMO-FIX"
for /f %%T in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set "STAMP=%%T"
set "WORK=C:\ksstretchfullscreen-!STAMP!"
set "FINAL=%USERPROFILE%\Downloads\KS-STRETCH-FULLSCREEN-1682015.apk"
set "LOG=%TEMP%\ks-stretch-fullscreen-1682015-build.txt"
set "JAVASAVE=%USERPROFILE%\.kristalstreams-java-home.txt"

echo.
echo ==========================================================
echo   KRISTAL STREAMS 1.6.8 RC1 R2 - STRETCH FULLSCREEN
echo   FRESH APK: KS-STRETCH-FULLSCREEN-1682015.apk
echo ==========================================================
echo.
...
findstr /c:"1.6.8-stretch-fullscreen" "%WORK%\app\build.gradle.kts" >nul
if errorlevel 1 (
...
cd /d "%WORK%"
set "BUILDPS=%TEMP%\ks_stretch_fullscreen_1682015_gradle_build.ps1"
...
if defined USBDRIVE (
    set "USBCOPY=!USBDRIVE!\KS-STRETCH-FULLSCREEN-1682015.apk"
...
echo ==========================================================
echo.
echo       KS STRETCH FULLSCREEN BUILD SUCCESSFUL
echo.
echo ==========================================================
echo.
echo APK:
...
echo.
echo Install only KS-STRETCH-FULLSCREEN-1682015.apk shown above.
...

:::END GRADLE
:::BEGIN AUDIT
...

...

...

U3RyaW5nPj8pOiBJbnQgPSAwCn0K
:::END IMMERSIVE
