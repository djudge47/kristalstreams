...
title Kristal Streams Duration-Width EPG

set "SOURCE=C:\KristalStreams168RC1R2\KristalStreams-1.6.8-RC1-R2-LEGACY-DEMO-FIX"
for /f %%T in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set "STAMP=%%T"
set "WORK=C:\ksepgduration-!STAMP!"
set "FINAL=%USERPROFILE%\Downloads\KS-EPG-DURATION-1682001.apk"
set "LOG=%TEMP%\kristalstreams-epg-duration-build.txt"
set "JAVASAVE=%USERPROFILE%\.kristalstreams-java-home.txt"

echo.
echo ==========================================================
echo   KRISTAL STREAMS 1.6.8 RC1 R2 - DURATION-WIDTH EPG
echo   FRESH APK: KS-EPG-DURATION-1682001.apk
echo ==========================================================
echo.
echo Baseline: known-good R2
echo Uses the successful rebuilt grid with duration-width cards.
echo Longer shows extend continuously from start through finish.
...
echo [2/6] Installing the duration-width EPG component...
...
if errorlevel 1 (
    echo ERROR: Could not install the duration-width EPG component.
    pause
    exit /b 1
)

echo [3/6] Verifying the duration-width EPG...
...
findstr /c:"1.6.8-epg-duration" "%WORK%\app\build.gradle.kts" >nul
if errorlevel 1 (
    echo ERROR: EPG duration version verification failed.
    pause
    exit /b 1
)
...
echo.
echo [5/6] Building the duration-width EPG...
echo Gradle progress will appear below.
echo.

cd /d "%WORK%"
set "BUILDPS=%TEMP%\ks_epg_duration_gradle_build.ps1"
...
if defined USBDRIVE (
    set "USBCOPY=!USBDRIVE!\KS-EPG-DURATION-1682001.apk"
...
echo ==========================================================
echo.
echo       KRISTAL STREAMS DURATION-WIDTH EPG BUILD SUCCESSFUL
echo.
echo ==========================================================
echo.
echo APK:
...
echo.
echo Install only KS-EPG-DURATION-1682001.apk shown above.
echo Longer shows now extend as one card from start through finish.
echo The rebuilt grid still prevents stacking and uneven spacing.
echo.
...
bnQgPT0gbnVsbCAmJiAhbG9hZGluZwogICAgICAgICAgICB2YWwgdGl0bGUgPSB3aGVuIHsKICAg
...

...

:::END ADAPTER
:::BEGIN GRADLE
...
ZXJzaW9uQ29kZSA9IDE2ODIwMDEKICAgICAgICB2ZXJzaW9uTmFtZSA9ICIxLjYuOC1lcGctZHVy
YXRpb24iCiAgICB9CgogICAgYnVpbGRGZWF0dXJlcyB7CiAgICAgICAgdmlld0JpbmRpbmcgPSBm
...
:::END GRADLE
:::BEGIN AUDIT

...
IHNheSBOTyBHVUlERSBEQVRBLgoKVkVSU0lPTgotIHZlcnNpb25Db2RlIDE2ODIwMDEKLSB2ZXJz
aW9uTmFtZSAxLjYuOC1lcGctZHVyYXRpb24K
:::END AUDIT
