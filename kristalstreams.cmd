...
title Kristal Streams Live TV Logo Visibility

set "SOURCE=C:\KristalStreams168RC1R2\KristalStreams-1.6.8-RC1-R2-LEGACY-DEMO-FIX"
for /f %%T in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set "STAMP=%%T"
set "WORK=C:\kslivelogos-!STAMP!"
set "FINAL=%USERPROFILE%\Downloads\KS-LIVE-LOGO-VISIBILITY-1682009.apk"
set "LOG=%TEMP%\kristalstreams-live-logo-visibility-build.txt"
set "JAVASAVE=%USERPROFILE%\.kristalstreams-java-home.txt"

echo.
echo ==========================================================
echo   KRISTAL STREAMS 1.6.8 RC1 R2 - LIVE TV LOGO VISIBILITY
echo   FRESH APK: KS-LIVE-LOGO-VISIBILITY-1682009.apk
echo ==========================================================
echo.
echo Baseline: known-good R2
echo Lightens every regular Live TV channel-logo panel.
echo Makes the top-left Live TV navigation artwork transparent.
...
echo [2/6] Installing Live TV logo visibility...
...
if errorlevel 1 (
    echo ERROR: Could not install Live TV logo files.
    pause
    exit /b 1
)
...
echo [3/6] Verifying Live TV logo visibility...
...
findstr /c:"1.6.8-live-logo-visibility" "%WORK%\app\build.gradle.kts" >nul
if errorlevel 1 (
    echo ERROR: Live TV logo visibility version verification failed.
    pause
    exit /b 1
)
...
echo.
echo [5/6] Building Live TV logo visibility...
echo Gradle progress will appear below.
echo.

cd /d "%WORK%"
set "BUILDPS=%TEMP%\ks_live_logo_visibility_gradle_build.ps1"
...
if defined USBDRIVE (
    set "USBCOPY=!USBDRIVE!\KS-LIVE-LOGO-VISIBILITY-1682009.apk"
...
echo ==========================================================
echo.
echo       KRISTAL STREAMS LIVE TV LOGO VISIBILITY BUILD SUCCESSFUL
echo.
echo ==========================================================
echo.
echo APK:
...
echo.
echo Install only KS-LIVE-LOGO-VISIBILITY-1682009.apk shown above.
echo All regular Live TV channel logos now use a light background.
echo The top-left Live TV navigation artwork now has a transparent background.
...
ZXJzaW9uQ29kZSA9IDE2ODIwMDkKICAgICAgICB2ZXJzaW9uTmFtZSA9ICIxLjYuOC1saXZlLWxv
Z28tdmlzaWJpbGl0eSIKICAgIH0KCiAgICBidWlsZEZlYXR1cmVzIHsKICAgICAgICB2aWV3Qmlu
...
:::END GRADLE
:::BEGIN AUDIT

:::END AUDIT
...

bGRBdChpbmRleCksIGFjdGlvbikKICAgICAgICB9CiAgICB9Cn0K
:::END UICONTEXT
