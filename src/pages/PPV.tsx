...
const ppvEvents: PPVEvent[] = [
  { id: '6', title: 'UFC 329: McGregor vs Holloway 2', date: 'July 11, 2026', time: '10:00 PM ET', venue: 'T-Mobile Arena, Las Vegas', sport: 'UFC', mainEvent: 'Conor McGregor vs Max Holloway', description: 'Conor McGregor returns for a blockbuster rematch with former champion Max Holloway during International Fight Week', featured: true, image: ufc329Image },
  { id: '2', title: '2026 MLB All-Star Game', date: 'July 14, 2026', time: '8:00 PM ET', venue: 'Citizens Bank Park, Philadelphia', sport: 'MLB', mainEvent: 'American League vs National League', description: 'Baseball\'s biggest stars take the field in Philadelphia for the Midsummer Classic', featured: true, image: mlbAllStarImage },
  { id: '1', title: 'WNBA All-Star Game 2026', date: 'July 25, 2026', time: 'Time TBA', venue: 'United Center, Chicago', sport: 'WNBA', mainEvent: 'WNBA All-Star Game', description: 'The league\'s brightest stars meet in Chicago for the 2026 WNBA All-Star showcase', featured: true, image: '/ppv/wnba-all-star-2026.avif' },
  { id: '7', title: 'WWE SummerSlam 2026', date: 'August 1–2, 2026', time: 'Start Time TBA', venue: 'U.S. Bank Stadium, Minneapolis', sport: 'WWE', mainEvent: 'Two-Night SummerSlam', description: 'WWE brings one of its biggest events of the year to Minneapolis for a massive two-night stadium show', featured: true, image: '/ppv/wwe-summerslam-2026.svg' },
  { id: '4', title: 'Leagues Cup 2026', date: 'August 4 – September 6, 2026', time: 'Schedule Varies', venue: 'MLS & Liga MX Stadiums', sport: 'MLS', mainEvent: 'Leagues Cup Final', description: 'Top MLS and Liga MX clubs compete across North America for the Leagues Cup title', featured: true, image: '/ppv/leagues-cup-2026.jpg' },
  { id: '8', title: 'UFC 330: Makhachev vs Garry', date: 'August 15, 2026', time: '9:00 PM ET', venue: 'Xfinity Mobile Arena, Philadelphia', sport: 'UFC', mainEvent: 'Islam Makhachev vs Ian Machado Garry', description: 'Islam Makhachev defends the welterweight championship against Ian Machado Garry in Philadelphia', featured: true, image: 'https://images.unsplash.com/photo-1680022548963-1d8e630a272b?auto=format&fit=crop&w=1200&q=85' },
  { id: '3', title: 'Mayer vs Cameron', date: 'August 29, 2026', time: 'Time TBA', venue: 'Birmingham, England', sport: 'Boxing', mainEvent: 'Super Welterweight Title Unification', description: 'Mikaela Mayer and Chantelle Cameron meet in a major world-title unification bout', featured: true, image: 'https://images.unsplash.com/photo-1549719386-74dfcbf7dbed?auto=format&fit=crop&w=1200&q=85' },
  { id: '9', title: 'WWE Money in the Bank 2026', date: 'September 6, 2026', time: 'Start Time TBA', venue: 'Smoothie King Center, New Orleans', sport: 'WWE', mainEvent: 'Men\'s & Women\'s Money in the Bank Matches', description: 'WWE Superstars battle in signature ladder matches for guaranteed future championship opportunities', featured: true, image: 'https://images.unsplash.com/photo-1636391134068-083dd5e3209b?auto=format&fit=crop&w=1200&q=85' },
  { id: '11', title: '2026 NFL Kickoff: Patriots vs Seahawks', date: 'September 9, 2026', time: '8:20 PM ET', venue: 'Lumen Field, Seattle', sport: 'NFL', mainEvent: 'New England Patriots vs Seattle Seahawks', description: 'The 2026 NFL season opens with a prime-time Super Bowl LX rematch in Seattle', featured: true, image: nflKickoffImage },
  { id: '5', title: '2026 NHL Heritage Classic', date: 'October 25, 2026', time: 'Time TBA', venue: 'Princess Auto Stadium, Winnipeg', sport: 'NHL', mainEvent: 'Winnipeg Jets vs Montreal Canadiens', description: 'Canadian rivals meet outdoors in one of hockey\'s signature showcase events', featured: true, image: 'https://images.unsplash.com/photo-1580748141549-71748dbe0bdc?auto=format&fit=crop&w=1200&q=85' },
  { id: '10', title: 'NBA 2026 Season', date: '2026–27 Season', time: 'Schedule TBA', venue: 'NBA Arenas', sport: 'NBA', mainEvent: 'Regular Season & Playoffs', description: 'Follow marquee NBA matchups throughout the 2026–27 season', featured: true, image: '/ppv/nba-2026-season.svg' }
];
    ...
    <div className="min-h-screen bg-dark-300 py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-16">
          {features.map(({ icon: Icon, title, text }) => (
            <div key={title} className="bg-dark-100 rounded-xl p-6 border border-gray-800 text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">{title}</h3><p className="text-gray-400 text-sm">{text}</p>
            </div>
          ))}
        </div>
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {sports.map(sport => (
            <button key={sport} onClick={() => setSelectedSport(sport)} className={`px-6 py-3 rounded-lg font-medium transition-all duration-300 ${selectedSport === sport ? 'bg-primary text-white shadow-lg shadow-primary/20' : 'bg-dark-100 text-gray-400 border border-gray-800 hover:border-primary hover:text-white'}`}>{sport === 'all' ? 'All Events' : sport}</button>
          ))}
        </div>
        ...
        <div className="mt-20 max-w-4xl mx-auto">
          ...
          <div className="space-y-6">{faqs.map(([question, answer]) => <div key={question} className="bg-dark-100 rounded-xl p-6 border border-gray-800"><h3 className="text-xl font-semibold text-white mb-3">{question}</h3><p className="text-gray-400">{answer}</p></div>)}</div>
        </div>
      </div>
    </div>
  );
