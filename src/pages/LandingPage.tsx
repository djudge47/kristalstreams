    ...
    <div className="min-h-screen bg-dark-300">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-r from-dark-300 via-dark-300/90 to-dark-300/70"></div>
          <img 
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              Stream the World's
              <span className="block text-primary">Best Entertainment</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <button
                ...
                className="bg-primary hover:bg-red-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center"
              >
              ...
              <button
                ...
                className="border-2 border-white text-white hover:bg-white hover:text-dark-300 px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 flex items-center justify-center"
              >
                View Pricing
            ...
            <div className="flex flex-wrap justify-center gap-8 text-center">
              {stats.map((stat, index) => (
                <div key={index} className="bg-dark-200/50 backdrop-blur-sm rounded-lg p-4 min-w-[120px]">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div 
                key={index}
                className="bg-dark-100 p-8 rounded-xl border border-gray-800 hover:border-primary transition-all duration-300 transform hover:-translate-y-2 group"
              >
                <div className="mb-6 p-3 bg-dark-300 inline-block rounded-lg group-hover:bg-primary/10 transition-colors duration-300">
                  {feature.icon}
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-8 items-center justify-center">
            <div className="flex flex-col items-center group">
              <div className="bg-dark-100 p-6 rounded-xl mb-4 group-hover:bg-primary/10 transition-colors duration-300">
            ...
            <div className="flex flex-col items-center group">
              <div className="bg-dark-100 p-6 rounded-xl mb-4 group-hover:bg-primary/10 transition-colors duration-300">
                <Monitor className="h-12 w-12 text-[#FF9900]" />
              </div>
              <span className="text-gray-400 text-center">Fire TV</span>
            </div>
            <div className="flex flex-col items-center group">
              <div className="bg-dark-100 p-6 rounded-xl mb-4 group-hover:bg-primary/10 transition-colors duration-300">
                <Monitor className="h-12 w-12 text-[#6C3C97]" />
              </div>
            ...
            <div className="flex flex-col items-center group">
              <div className="bg-dark-100 p-6 rounded-xl mb-4 group-hover:bg-primary/10 transition-colors duration-300">
                <Monitor className="h-12 w-12 text-[#4285F4]" />
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <button 
              ...
              className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-4 bg-primary hover:bg-red-700 text-white p-3 rounded-full transition-colors duration-200"
            >
            ...
            <button 
              ...
              className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-4 bg-primary hover:bg-red-700 text-white p-3 rounded-full transition-colors duration-200"
            >
      ...
      <section className="py-20 bg-dark-300">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-dark-100 rounded-xl p-8 border border-gray-800 hover:border-primary transition-all duration-300">
              <h3 className="text-2xl font-bold text-white mb-4">Basic</h3>
              <div className="text-4xl font-bold text-primary mb-6">$20<span className="text-lg text-gray-400">/month</span></div>
              ...
              <button className="w-full bg-dark-200 hover:bg-primary text-white py-3 rounded-lg transition-colors duration-200">
                Choose Basic
              </button>
            </div>

            <div className="bg-dark-100 rounded-xl p-8 border-2 border-primary relative transform scale-105">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-primary text-white px-4 py-1 rounded-full text-sm font-semibold">
                Most Popular
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">Premium</h3>
              <div className="text-4xl font-bold text-primary mb-6">$35<span className="text-lg text-gray-400">/month</span></div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center text-gray-300">
                  <Check className="w-5 h-5 text-green-500 mr-3" />
                  4 Connections
              ...
              <button className="w-full bg-primary hover:bg-red-700 text-white py-3 rounded-lg transition-colors duration-200">
                Choose Premium
              </button>
            </div>
            ...
            <div className="bg-dark-100 rounded-xl p-8 border border-gray-800 hover:border-primary transition-all duration-300">
              ...
              <div className="text-4xl font-bold text-primary mb-6">$45<span className="text-lg text-gray-400">/month</span></div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center text-gray-300">
                  <Check className="w-5 h-5 text-green-500 mr-3" />
                  4 Connections
          ...
          <div className="text-center mt-12">
            <button
              onClick={handleViewPricing}
              className="bg-primary hover:bg-red-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300"
            >
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={handleStartTrial}
                className="bg-white text-primary hover:bg-gray-100 px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center"
              >
                <Play className="w-6 h-6 mr-2" />
                Start Free Trial
              </button>
              <button
                ...
                className="border-2 border-white text-white hover:bg-white hover:text-primary px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 flex items-center justify-center"
              >
                Learn More
                <ArrowRight className="w-6 h-6 ml-2" />
              </button>
