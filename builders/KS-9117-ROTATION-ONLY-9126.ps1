...
$work = "C:\ks-9117-rotation-only-9126-$stamp"
$decoded = Join-Path $work 'decoded'
$unsigned = Join-Path $work 'KristalStreams-KS-ROTATION-ONLY-9126-unsigned.apk'
$aligned = Join-Path $work 'KristalStreams-KS-ROTATION-ONLY-9126-aligned.apk'
$desktop = [Environment]::GetFolderPath('Desktop')
$final = Join-Path $desktop 'KristalStreams-KS-ROTATION-ONLY-9126.apk'
...
# Search only known Kristal Streams locations. Prefer the exact signed TEST APK and ignore UNSIGNED/ALIGNED intermediates.
...
# VersionCode bump only so Android can install it over 9117. VersionName and all app content stay unchanged.
