...
$outApk = Join-Path $env:USERPROFILE 'Desktop\KristalStreams-BASELINE-RESTORE-1682100.apk'
$utf8 = New-Object System.Text.UTF8Encoding($false)

Write-Host ''
Write-Host '============================================================' -ForegroundColor Cyan
Write-Host ' KRISTAL STREAMS - BASELINE RESTORE 1682100' -ForegroundColor Cyan
...
$gradleText = [regex]::Replace($gradleText, 'versionCode\s*=\s*\d+', 'versionCode = 1682100')
$gradleText = [regex]::Replace($gradleText, 'versionName\s*=\s*"[^"]*"', 'versionName = "1.6.8-baseline-restore-1682100"')
